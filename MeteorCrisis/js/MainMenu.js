...
MeteorCrisis.StateMainMenu.prototype = {
	...
	create: function() {
		...
		buttonStyle = { font: "60px Tahoma", fill: "#000000", wordWrap: true, wordWrapWidth: button_play.width, align: "center"};
		...
		score = this.add.text(this.world.centerX - 100, 125, "HIGH SCORE: " + MeteorCrisis.highscore, {font: "28px Courier New", fill: "#FFFFFF"});
	},
...
MeteorCrisis.StateHelpMenu.prototype = {
	...
	create: function() {
		...
		text_help = this.add.text(150, 225, "The goal is to try to shoot as many meteors as you can and do not explode!", {font: "26px Courier New", fill: "#FFFFFF", wordWrap: true, wordWrapWidth: 600, align: "center"});
